...
#Min and Max stock and salary quiz
salary=[]
stock=[]
for key in data_dict:
    sto = data_dict[key]['exercised_stock_options']
    sal = data_dict[key]['salary']
    if not np.isnan(float(sto)):
        stock.append(float(sto))
    if not np.isnan(float(sal)):
        salary.append(float(sal))

print("The minimum stock value is : ",min(stock))
print("The maximum stock value is : ",max(stock))
